...
## 2) Как приложение выбирает, куда идти

### Для users
Приложение отправляет запрос в компонент **Shard Router**.
...
## 3) Репликация и режимы работы серверов (как на диаграмме)
...
## 4) Как обычно распределяют чтение и запись
...
## 5) Зачем это делают (простыми словами)
