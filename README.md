...
Это не шардинг в строгом смысле (скорее вертикальная декомпозиция по доменам), но именно так обычно и делают “самое простое” разделение.
